...
describe.each(currencies)(
  ...
  ({ locale, currencyCode, currencySymbol, currencyName }) => {
    ...
    describe('add items to cart', () => {
      ...
      it('adds multiple items to the cart after items have already been added without removing the existing items', () => {
        cart.addItems([
          [PRODUCT_DATA.PRODUCT_A_10, 2],
          [PRODUCT_DATA.PRODUCT_B_20, 3],
        ]);
      ...
      describe('write receipt to HTML file', () => {
        ...
        it('writes a receipt to an HTML file with no discount', () => {
          ...
          const expectedReceipt = [
            ...
            `          <span style="font-size: 0.75rem"><strong>ID:</strong> ${PRODUCT_DATA.PRODUCT_G_50.id}</span>`,
            `          <span style="font-size: 0.75rem"><strong>Description:</strong> ${PRODUCT_DATA.PRODUCT_G_50.description}</span>`,
            `        </div>`,
            `      </td>`,
            ...
            `          <span style="font-size: 0.75rem"><strong>ID:</strong> ${PRODUCT_DATA.PRODUCT_H_25.id}</span>`,
            `          <span style="font-size: 0.75rem"><strong>Description:</strong> ${PRODUCT_DATA.PRODUCT_H_25.description}</span>`,
            `        </div>`,
            `      </td>`,
        ...
        it('writes a receipt to an HTML file with 5% discount', () => {
          ...
          const expectedReceipt = [
            ...
            `          <span style="font-size: 0.75rem"><strong>ID:</strong> ${PRODUCT_DATA.PRODUCT_A_10.id}</span>`,
            `          <span style="font-size: 0.75rem"><strong>Description:</strong> ${PRODUCT_DATA.PRODUCT_A_10.description}</span>`,
            `        </div>`,
            `      </td>`,
